...
(() => {
  ...
  // 0_Extraction/Contracts/GameConstants.js
  var HouseCardState;
  ...
  var modifyingGameLogTypes = /* @__PURE__ */ new Set([
    "combat-result",
    "turn-begin",
    "march-resolved",
  ...
  var relatedCombatResultTypes = /* @__PURE__ */ new Set([
    "killed-after-combat",
  ...
  var combatTerminationLogTypes = /* @__PURE__ */ new Set([
    "attack",
    "march-resolved",
    "combat-result",
    // not really possible as "attack" must "preceed", but for safety...
    "action-phase-resolve-consolidate-power-began",
    "winner-declared",
    "turn-begin",
    "westeros-phase-began"
  ]);
  var replacementLogTypes = /* @__PURE__ */ new Set(["player-replaced", "vassal-replaced"]);
  var ReplayConstants = class {
  ...
  var extractMilitaryData = (logData, gameRoundMapping, gameState) => {
    ...
    logData.forEach((log, index) => {
      ...
      if (winnerStats === void 0 || loserStats === void 0)
  ...
  // 0_Extraction/Framework/ExtractGameData.js
