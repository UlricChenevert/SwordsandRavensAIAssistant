import { Factions, GameLocation, HouseCard } from "../Data/GameTypes.js";
...
type Graph2D = {xAxis : number[], yAxis : number[]}

// Outer array indexed by placement (0 = 1st place, 1 = 2nd place, …).
// Each inner array contains one entry per bid amount with success probability.
type BidPlacementChart = { amount: number; probability: number }[][]
