...
import { CardChoiceAnalysisData, IGameDataAnalyzer } from "../../../Contracts/AnalysisContracts.js";
...
export const analyzePossibleCardChoice : IGameDataAnalyzer<CardChoiceAnalysisData> = (data: ScrapedData) : CardChoiceAnalysisData => {
