import { IGameDataExtractor, IGameLogDataExtractor } from "../../!Contracts/ExtractionContracts.js";
import { EntireGame, GameClient, GameLog, IngameGameState } from "../Contracts/GameTypes.js";
...
export const extractLogData = (logs : GameLog[], Extractors : IGameLogDataExtractor<object>[], gameState : IngameGameState) => {
